...
function addUsername(list) {
  ...
  return list.map(function(elm) {
     elm.username  =  (elm.firstName + elm.lastName[0]).toLowerCase() + (new Date().getFullYear() -elm.age);
                          //lowercase first and last and get fullyear
    return elm // return the modified object
  })
}
...
//   // thank you for checking out the Coding Meetup kata :)
//   return list.map(function(elm) {
//    let arr = elm.lastName.split('');
//     return elm.username  = elm.firstName.toLowerCase + arr[0].toLowerCase + (toString(2017 - elm.age);
//   })
// }
