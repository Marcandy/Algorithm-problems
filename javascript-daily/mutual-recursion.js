...
function F(num) {
  if(num >= 1) { // setting the condition
    return num - M(F(num - 1)); //doing recursion with a function that now difined yet-- buits hoisted below
  }
  return 1;
}

function M(num) {
  if(num) {// checkoing to see if num exist
