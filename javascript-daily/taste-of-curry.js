...
function curry(fun, ...arg1) {//all parm with spread operator
  return function(...arg2) {
    return fun.call(this,...arg1,...arg2);//applying .call with this
                                            // referencing any obj which invokes it
  }
}
...
function curry(fun) {
  ...
  return function() {
    return fun.apply(
      this,
      curried.concat(Array.prototype.slice.call(arguments))
    );
  }
}
